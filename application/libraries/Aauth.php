...
class Aauth {
	 ...
	 */
	public function create_user($email, $pass, $username = FALSE, $position, $optional_data = []) {
		...
		$data = array(
			...
			'username' => (!$username) ? '' : $username ,
                        'position' => implode(',', (array) $position),
	 ...
	 * @return bool Update fails/succeeds
	 */
	public function update_user($user_id, $email = FALSE, $pass = FALSE, $username = FALSE, $position, $optional_data = []) {
		...
		if ($username != FALSE) {
			...
			$data['username'] = $username;
                ...
                $data['position'] = implode(',', (array) $position);
