...
class MY_Model extends CI_Model {
   ...
   public function reportShow($path, $parameter = array()) {
        error_reporting(0);   
        
        include('rptengine/class/tcpdf/tcpdf.php');
        include("rptengine/class/PHPJasperXML.inc.php");
...
//        $PHPJasperXML->arrayParameter = array("orderNumber" => "2019-001.220-AII");
