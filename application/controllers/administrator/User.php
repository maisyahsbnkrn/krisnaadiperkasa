	...
	*/
	public function add_save()
	{
		...
		if ($this->form_validation->run()) {
			...
			$save_user = $this->aauth->create_user($this->input->post('email'), $this->input->post('password'), $this->input->post('username'),$this->input->post('position'), $save_data);
	...
	*/
	public function edit_save($id)
	{
		...
		if ($this->form_validation->run()) {
			...
			$save_user = $this->aauth->update_user($id, $this->input->post('email'), $password, $this->input->post('username'),$this->input->post('position'), $save_data);
