                   ...
                   <div class="form-group ">
                    ...
                    <div class="form-group ">
                     ...
                     <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                            <select  class="form-control chosen-select" name="position[]" id="position"  placeholder="Select positions">
                                <option selected="selected" value="<?= $user->position; ?>"  ><?= ucwords($user->position); ?></option>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                           <select  class="form-control chosen-select" name="group[]" id="group"  placeholder="Select groups">
