         ...
         <div class="box box-warning">
            <div class="box-body ">
               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="form-group ">
                        <label for="content" class="col-sm-2 control-label">Position <i class="required">*</i></label>

                        <div class="col-sm-8">
                           <select  class="form-control chosen chosen-select" name="position[]" id="position" tabi-ndex="5"  placeholder="Select positions">
                             <option value=""></option>   
                               <?php foreach (db_get_all_data('aauth_users_position') as $row): ?>
                            <option value="<?= $row->position_name; ?>"><?= ucwords($row->position_name); ?></option>
                            <?php endforeach; ?>  
                           </select>
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                            <option value=""></option> 
                           <select  class="form-control chosen chosen-select" name="group[]" id="group" tabi-ndex="5"  placeholder="Select groups">
                            <?php foreach (db_get_data_group('aauth_groups') as $row): ?>
