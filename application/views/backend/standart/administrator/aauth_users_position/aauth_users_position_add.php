...
<section class="content-header">
    <h1>
        Users Position        <small><?= cclang('new', ['Users Position']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Users Position']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="position_name" id="position_name" placeholder="Position" value="<?= set_value('position_name'); ?>">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/aauth_users_position/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
