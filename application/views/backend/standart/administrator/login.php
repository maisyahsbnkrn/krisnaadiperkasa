...
<head>
  ...
  <link rel="shortcut icon" href="<?= BASE_ASSET; ?>/img/favicon.png" type="image/x-icon">
...
<div class="login-box">
  <div class="login-logo">
    <img src="<?= BASE_ASSET; ?>/img/logo.png">
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
      <p class="login-box-msg"><b><?= cclang('sign_to_start_your_session'); ?></b></p>
    ...
    <?php endif; ?>
     <?= form_open('', [
      ...
      <div class="form-group has-feedback <?= form_error('username') ? 'has-error' :''; ?>">
        <input type="text" class="form-control" placeholder="Email" name="username" value="<?= set_value('username', ''); ?>">
      ...
      <div class="g-recaptcha" data-sitekey="6LeuTxsUAAAAAOjqXCsslvi64dPQELKFXunoo4fV" id="recaptcha"></div> 
...
<!--        <div class="col-xs-8">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button id= "submit" type="submit" class="btn btn-primary btn-block btn-flat"><?= cclang('sign_in'); ?></button>
        </div>
        <!-- /.col -->
      </div>
    <?= form_close(); ?>
