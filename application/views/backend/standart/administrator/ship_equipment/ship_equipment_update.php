...
<section class="content-header">
    <h1>
        Ship Equipment        <small>Edit Ship Equipment</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Ship Equipment</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('administrator/ship_equipment/edit_save/'.$this->uri->segment(4)), [
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="company" id="company" data-placeholder="Select Company" >
                                    ...
                                    <option <?=  $row->id_company ==  $ship_equipment->company ? 'selected' : ''; ?> value="<?= $row->id_company ?>"><?= $row->name; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="ship_name" id="ship_name" data-placeholder="Select Ship Name" >
                                    ...
                                    <option <?=  $row->id_ship ==  $ship_equipment->ship_name ? 'selected' : ''; ?> value="<?= $row->id_ship ?>"><?= $row->ship_name; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                                </small>
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="name" id="name" data-placeholder="Select Name" >
                                    ...
                                    <option <?=  $row->logistic_equipment_name ==  $ship_equipment->name ? 'selected' : ''; ?> value="<?= $row->logistic_equipment_name ?>"><?= $row->logistic_equipment_name; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                                </small>
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="maker" id="maker" data-placeholder="Select Maker" >
                                    <option value=""></option>
                                    <?php foreach (db_get_all_data('logistic_equipment') as $row): ?>
                                    <option <?=  $row->logistic_maker ==  $ship_equipment->maker ? 'selected' : ''; ?> value="<?= $row->logistic_maker ?>"><?= $row->logistic_maker; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                                </small>
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="type" id="type" data-placeholder="Select Type" >
                                    <option value=""></option>
                                    <?php foreach (db_get_all_data('logistic_equipment') as $row): ?>
                                    <option <?=  $row->logistic_equipment_type ==  $ship_equipment->type ? 'selected' : ''; ?> value="<?= $row->logistic_equipment_type ?>"><?= $row->logistic_equipment_type; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                                </small>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="serial_number" id="serial_number" placeholder="Serial Number" value="<?= set_value('serial_number', $ship_equipment->serial_number); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control pull-right datepicker" name="manufacture_date"  placeholder="Manufacture Date" id="manufacture_date" value="<?= set_value('ship_equipment_manufacture_date_name', $ship_equipment->manufacture_date); ?>">
                            </div>
                            <small class="info help-block">
                            </small>
                            </div>
                            ...
                            <div class="col-sm-6">
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control pull-right datepicker" name="beacon"  placeholder="Beacon" id="beacon" value="<?= set_value('ship_equipment_beacon_name', $ship_equipment->beacon); ?>">
                            </div>
                            <small class="info help-block">
                            </small>
                            </div>
                            ...
                            <div class="col-sm-6">
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control pull-right datepicker" name="battery"  placeholder="Battery" id="battery" value="<?= set_value('ship_equipment_battery_name', $ship_equipment->battery); ?>">
                            </div>
                            <small class="info help-block">
                            </small>
                            </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group date col-sm-8">
                                    <input type="text" class="form-control pull-right datepicker" name="hru"  placeholder="Hru" id="hru" value="<?= set_value('ship_equipment_hru_name', $ship_equipment->hru); ?>">
                                </div>
                                <small class="info help-block">
                                </small>
                            </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group date col-sm-8">
                                    <input type="text" class="form-control pull-right datepicker" name="magnetron"  placeholder="Magnetron" id="magnetron" value="<?= set_value('ship_equipment_magnetron_name', $ship_equipment->magnetron); ?>">
                                </div>
                                <small class="info help-block">
                                </small>
                            </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group date col-sm-8">
                                    <input type="text" class="form-control pull-right datepicker" name="ups_battery"  placeholder="UPS Battery" id="ups_battery" value="<?= set_value('ship_equipment_ups_battery_name', $ship_equipment->ups_battery); ?>">
                                </div>
                                <small class="info help-block">
                                </small>
                            </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group date col-sm-8">
                                    <input type="text" class="form-control pull-right datepicker" name="emergency_battery"  placeholder="Emergency Battery" id="emergency_battery" value="<?= set_value('ship_equipment_emergency_battery_name', $ship_equipment->emergency_battery); ?>">
                                </div>
                                <small class="info help-block">
                                </small>
                            </div>
                          ...
                          <div class="form-group ">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group date col-sm-8">
                                    <input type="text" class="form-control pull-right datepicker" name="annual_test"  placeholder="Annual Test" id="annual_test" value="<?= set_value('ship_equipment_annual_test_name', $ship_equipment->annual_test); ?>">
                                </div>
                                <small class="info help-block">
                                </small>
                            </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: form_ship_equipment.attr('action'),
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            var id = $('#ship_equipment_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
