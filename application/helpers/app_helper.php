...
if(!function_exists('db_get_data_group')) {
	function db_get_data_group() {
            $ci = & get_instance();
	    $query = $ci->db->query("SELECT * from aauth_groups where id >5");
            return $query->result();
        
	}
}

if(!function_exists('db_get_data_engineer')) {
	function db_get_data_engineer() {
            $ci = & get_instance();
	    $query = $ci->db->query("SELECT aauth_users.full_name from aauth_users left join aauth_user_to_group on aauth_users.id = aauth_user_to_group.user_id where aauth_user_to_group.group_id in('9','10') ");
            return $query->result();
        
	}
}
if(!function_exists('db_get_data_equipment_by_order_number')) {
	function db_get_data_equipment_by_order_number($table_name = null, $order_number=null) {
		$ci =& get_instance();
                $ci->db->select('task_equipment_name');
                $ci->db->select('task_equipment_type');
		$ci->db->where('order_number_task',$order_number);
		$query = $ci->db->get($table_name);
...
if(!function_exists('db_get_data_sparepart_by_order_number')) {
	function db_get_data_sparepart_by_order_number($table_name = null, $order_number=null) {
		$ci =& get_instance();
                $ci->db->select('task_sparepart_name');
                $ci->db->select('task_sparepart_type');
		$ci->db->where('order_number_task',$order_number);
		$query = $ci->db->get($table_name);
...
if(!function_exists('db_get_all_data_logistic_equipment')) {
	function db_get_all_data_logistic_equipment($table_name = null, $where = false) {
		$ci =& get_instance();
...
if (! function_exists('db_get_all_logistic_equipment_type_name')) {

    function db_get_all_logistic_equipment_type_name($table_name = null, $where = false)
    {
        $ci =& get_instance();
        $ci->db->distinct();
        $ci->db->select('logistic_equipment_type_name');
            if ($where) 
            {
                $ci->db->where($where);
            }
...
if (! function_exists('db_get_all_logistic_equipment_name')) {

    function db_get_all_logistic_equipment_name($table_name = null, $where = false)
    {
        $ci =& get_instance();
        $ci->db->distinct();
        $ci->db->select('logistic_equipment_name');
            if ($where) 
            {
                $ci->db->where($where);
            }
...
if (! function_exists('db_get_all_logistic_equipment_sparepart_name')) {

    function db_get_all_logistic_equipment_sparepart_name($table_name = null, $where = false)
    {
        $ci =& get_instance();
        $ci->db->distinct();
        $ci->db->select('logistic_sparepart_equipment_name');
            if ($where) 
            {
                $ci->db->where($where);
            }
...
if (! function_exists('db_get_all_logistic_sparepart_type_name')) {

    function db_get_all_logistic_sparepart_type_name($table_name = null, $where = false)
    {
        $ci =& get_instance();
        $ci->db->distinct();
        $ci->db->select('logistic_sparepart_type_name');
            if ($where) 
            {
                $ci->db->where($where);
            }
